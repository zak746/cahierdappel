...
@media(max-width:640px){
  ...
  .tableau-eleves th:nth-child(2),.tableau-eleves td:nth-child(2){width:74px}
  .tableau-eleves th:nth-child(3),.tableau-eleves td:nth-child(3){width:54px}
  .tableau-eleves th:nth-child(4),.tableau-eleves td:nth-child(4){width:26px}
  .tableau-eleves input[type="text"],.tableau-eleves input[type="number"]{padding:7px 8px;font-size:14px;border-radius:9px}
  ...
  .tableau-annee th:nth-child(2),.tableau-annee td:nth-child(2),
  .tableau-annee th:nth-child(3),.tableau-annee td:nth-child(3){width:58px}
  .tableau-annee th:nth-child(4),.tableau-annee td:nth-child(4){width:46px}
  .tableau-annee th:last-child,.tableau-annee td:last-child{width:24px}
  .tableau-annee input[type="number"]{padding:7px 5px;text-align:center}
...
@media print{
  ...
  /* Page « registre à imprimer » : seule la grille sort sur le papier, en paysage,
     avec des traits assez nets pour être remplis au stylo. */
  ...
  .grille{font-size:8pt;width:100%}
  .grille th,.grille td{border:.5pt solid #444}
  .grille th{background:#f0f0f0;font-size:7pt;color:#000}
  .grille td{height:7.6mm}
  .grille .col-nom{min-width:0;width:20%}
  .grille-note{font-size:7.5pt;color:#333;margin-top:4mm}
  .grille-entete{margin-bottom:5mm}
  .grille-entete span{color:#000;font-size:7.5pt}
  .grille-entete i{border-bottom:.5pt solid #444}
}
`;
