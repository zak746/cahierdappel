...
@media(max-width:640px){
  ...
  /* Lignes de période : nom sur toute la largeur, puis les 2 nombres côte à côte. */
  .periode{padding:12px 13px;margin-bottom:9px;gap:9px;grid-template-columns:1fr 1fr}
  .periode>div:first-child{grid-column:1/-1}
  .periode label{font-size:9px;margin-bottom:4px;letter-spacing:.06em}
  .periode input{padding:8px 10px;font-size:15px;border-radius:9px}
