...
const favicon = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><rect width="64" height="64" rx="15" fill="#007aff"/><rect x="16" y="12" width="32" height="40" rx="4" fill="none" stroke="#fff" stroke-width="4"/><line x1="22" y1="24" x2="34" y2="24" stroke="#fff" stroke-width="4" stroke-linecap="round"/><line x1="22" y1="32" x2="34" y2="32" stroke="#fff" stroke-width="4" stroke-linecap="round"/><path d="M22 40l4 4 8-8" fill="none" stroke="#fff" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/></svg>`;
